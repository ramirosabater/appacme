...
@Component({
  selector: 'app-listado-rrhh',
  templateUrl: './listado-rrhh.component.html',
  styleUrls: ['./listado-rrhh.component.css']
})
export class ListadoRrhhComponent implements OnInit {
  ...
  getListadoRRHH() {
    this.herramientasPrendasService.getSolicitudesByRRHH().subscribe(
      res => {
        if (res != null)
