...
@Component({
  selector: 'app-solicitudes-dinero-administracion',
  templateUrl: './solicitudes-dinero-administracion.component.html',
  styleUrls: ['./solicitudes-dinero-administracion.component.css']
})
export class SolicitudesDineroAdministracionComponent implements OnInit {
  ...
  getSolicitudes(){
    this.solicitudesDineroService.getSolicitudesDineroAdministracion().subscribe(
      res => {
