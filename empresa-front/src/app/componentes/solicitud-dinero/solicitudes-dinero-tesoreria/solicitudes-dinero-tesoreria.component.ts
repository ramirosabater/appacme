...
@Component({
  selector: 'app-solicitudes-dinero-tesoreria',
  templateUrl: './solicitudes-dinero-tesoreria.component.html',
  styleUrls: ['./solicitudes-dinero-tesoreria.component.css']
})
export class SolicitudesDineroTesoreriaComponent implements OnInit {
  ...
  getSolicitudes(){
    this.solicitudesDineroService.getSolicitudesDineroByTesoreria().subscribe(
      res => {
