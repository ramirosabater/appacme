        ...
        <div
            ...
            <div>
                ...
                <div style="background-color: #FFFFFF; height:25px; ">
                    <h4 style="margin-top: 5px;">Solicitud de herramientas y prendas</h4>
                </div>
            ...
            <div style="padding: 2em 0 2em;margin: 0 10% 0 10% ">
                <div>
                    ...
                    <div style="text-align: left;">
                        ...
                        <h4>${data.jefe[0].apellido}, ${data.jefe[0].nombre} realiza la siguiente solicitud a nombre de ${data.empleado[0].apellido}, ${data.empleado[0].nombre}.
                             </h4>
                        <p style="font-family: serif;">
                            
                            <br>
                            Numero de solicitud: 00-${data.id_solicitud}
                            <br>
                            Lider: ${data.jefe[0].apellido}, ${data.jefe[0].nombre}
                            <br>
                            Empleado: ${data.empleado[0].apellido}, ${data.empleado[0].nombre}
                            <br>
...
`;
    ...
    <br>
    Item: 00-${dato.id_elemento}
    <br>
    Elemento: ${dato.desc_elemento}
    <br>
    Talle: ${dato.talle}	
    <br>
    Cantidad de elementos: ${dato.cantidad}
    <br>
    <br>
